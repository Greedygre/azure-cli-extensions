...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp up') as c:
        ...
        c.argument('custom_location', options_list=['--custom_location'], help="Resource ID of custom location. List using 'az customlocation list'.", validator=validate_custom_location_name_or_id)
        c.argument('connected_cluster_id', options_list=['--connected_cluster_id'], help="Resource ID of connected cluster. List using 'az connectedk8s list'.", configured_default='connected_cluster_id')

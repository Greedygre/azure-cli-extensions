...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp up') as c:
        ...
        c.argument('custom_location', options_list=['--custom_location'], configured_default='custom_location')
        c.argument('connected_cluster_id', options_list=['--connected_cluster_id'], configured_default='connected_cluster_id')
